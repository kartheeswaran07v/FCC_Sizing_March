...
def createSpecSheet(case_data, units, other):
    ...
    worksheet.write('C11', str(case_data[0][16]))
    ...
    # other values input
    worksheet.write(f'H6', other[0], cell_format1)
    worksheet.write(f'H8', other[1], cell_format1)
    worksheet.write(f'C5', other[2], cell_format1)
    worksheet.write(f'I11', other[3], f2)
    worksheet.write(f'J11', other[4], f2)
    worksheet.write(f'I12', other[5], f2)
    worksheet.write(f'C38', other[6], f2)
    worksheet.write(f'D38', other[7], cell_format1)
    worksheet.write(f'E38', other[8], f2)
    worksheet.write(f'C40', other[9], cell_format1)
    worksheet.write(f'C44', other[10], cell_format1)
    worksheet.write(f'C47', other[11], cell_format1)
    worksheet.write(f'C48', other[12], cell_format1)
    worksheet.write(f'C50', other[13], cell_format1)
    worksheet.write(f'C53', other[14], cell_format1)
    worksheet.write(f'C56', other[15], cell_format1)
    worksheet.write(f'C58', other[16], cell_format1)
    worksheet.write(f'C57', other[17], cell_format1)
    worksheet.write(f'C59', other[18], cell_format1)
    worksheet.write(f'C41', other[19], cell_format1)
    worksheet.write(f'C42', other[20], cell_format1)
